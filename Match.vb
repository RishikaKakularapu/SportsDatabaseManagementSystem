...
Public Class Match
    ...
    Private Sub Match_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        'TODO: This line of code loads data into the 'SportsDatabaseManagementSystemDataSet5.MATCH' table. You can move, or remove it, as needed.
        Me.MATCHTableAdapter.Fill(Me.SportsDatabaseManagementSystemDataSet5.MATCH)
